...
from src.data_loader import preparar_datos, dividir_datos, escalar_datos, generar_datos_procesados
from src.evaluator import evaluar_modelo
from src.predictor import pre
...
def main():
    ...
    # 5. Exportar matriz de confusión y guardar el mejor modelo
    best_model_name = df_results.iloc[0]['Modelo']
    print(f"\n[5/5] Exportando resultados para el mejor modelo: {best_model_name}")
